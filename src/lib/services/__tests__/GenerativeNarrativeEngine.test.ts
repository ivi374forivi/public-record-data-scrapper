...
import { Prospect, GenerativeContext, GrowthSignal, HealthScore, UCCFiling } from '../../types'
...
describe('GenerativeNarrativeEngine', () => {
  ...
  const mockProspect: Prospect = {
    ...
    uccFilings: [{ id: 'u-1', filingDate: '2023-01-01', securedParty: 'Bank A', debtorName: 'Test Corp', state: 'CA', status: 'active', filingType: 'UCC-1' }],
    growthSignals: [{ id: 'g-1', type: 'hiring', description: 'Hiring engineers', detectedDate: '2023-06-01', score: 0.8, confidence: 0.9 }],
    healthScore: { grade: 'B', score: 80, sentimentTrend: 'stable', reviewCount: 10, avgSentiment: 0.8, violationCount: 0, lastUpdated: '2023-06-01' },
    narrative: '',
  }
